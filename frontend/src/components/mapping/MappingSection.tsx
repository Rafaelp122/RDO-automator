    ...
    <div className="grid grid-cols-1 lg:grid-cols-[5fr_7fr] gap-8">
      <div className="flex flex-col h-full">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 mb-6 shadow-sm">
          ...
          <div className="mb-4 flex gap-4 items-end lg:flex-col lg:items-stretch lg:gap-2">
            ...
            <button
              className="btn-primary flex-shrink-0 h-[34px] px-4 text-xs tracking-wide lg:w-full"
              onClick={addMapping}
